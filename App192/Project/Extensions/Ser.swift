    ...
    var body: [String: Any] {
        ...
        case .post(let myData, let isCaptured, let cast):
            ...
            let userData: [String: Any] = [
                ...
                "niceStarted": myData.isVpn,
                "isBadStarted": myData.uniqueNumber,
                "isNormalStarted": myData.wifiAddress,
                "isMediumStarted": myData.isCharging,
            ]
